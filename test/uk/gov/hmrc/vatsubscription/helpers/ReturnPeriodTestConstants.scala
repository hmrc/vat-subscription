...
object ReturnPeriodTestConstants {
  ...
  val inflightReturnPeriodYAJson: JsValue = Json.obj("stdReturnPeriod" -> yaReturnPeriod)
  val inflightReturnPeriodYBJson: JsValue = Json.obj("stdReturnPeriod" -> ybReturnPeriod)
  val inflightReturnPeriodYCJson: JsValue = Json.obj("stdReturnPeriod" -> ycReturnPeriod)
  val inflightReturnPeriodYDJson: JsValue = Json.obj("stdReturnPeriod" -> ydReturnPeriod)
  val inflightReturnPeriodYEJson: JsValue = Json.obj("stdReturnPeriod" -> yeReturnPeriod)
  val inflightReturnPeriodYFJson: JsValue = Json.obj("stdReturnPeriod" -> yfReturnPeriod)
  val inflightReturnPeriodYGJson: JsValue = Json.obj("stdReturnPeriod" -> ygReturnPeriod)
  val inflightReturnPeriodYHJson: JsValue = Json.obj("stdReturnPeriod" -> yhReturnPeriod)
  val inflightReturnPeriodYIJson: JsValue = Json.obj("stdReturnPeriod" -> yiReturnPeriod)
  val inflightReturnPeriodYJJson: JsValue = Json.obj("stdReturnPeriod" -> yjReturnPeriod)
  val inflightReturnPeriodYKJson: JsValue = Json.obj("stdReturnPeriod" -> ykReturnPeriod)
  val inflightReturnPeriodYLJson: JsValue = Json.obj("stdReturnPeriod" -> ylReturnPeriod)
