...
import uk.gov.hmrc.vatsubscription.services.{DatabaseFailure, StoreVatNumberService, StoreVatNumberSuccess}
      ...
      implicit req =>
        authorised().retrieve(internalId) {
          case Some(id) =>
            ...
            storeVatNumberService.storeVatNumber(id, vrn) map {
              case Right(StoreVatNumberSuccess) => NoContent
              case Left(DatabaseFailure) => InternalServerError
            }
