...
import uk.gov.hmrc.vatsubscription.models.post.EmailPost
import uk.gov.hmrc.vatsubscription.services.{UpdateEmailService, VatCustomerDetailsRetrievalService}
