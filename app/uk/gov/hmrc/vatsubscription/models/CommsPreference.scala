...
object CommsPreference {
  ...
  implicit val updatePreferenceReads: Reads[CommsPreference] = (__ \ path).read[String].map {
    case PaperPreference.mdtpValue => PaperPreference
    case DigitalPreference.mdtpValue => DigitalPreference
  }
